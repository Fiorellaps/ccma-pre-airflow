...
#     "application_s3_location": "s3a://"+os.environ["ENTORN"]+"/enterprise/zapping/etl/ccma-etl-0.2314.4-jar-with-dependencies.jar",
...
#         "namespace": os.environ["ENTORN"], # ccma-pre | ccma-pro
...
#         "query_bucket_name": os.environ["ENTORN"] # ccma-pre | ccma-pro
#     }
...
#     # Sembla que la limitació d'un sol statement per file s'ha corregit: https://github.com/apache/airflow/issues/27610
...
#         subject=os.environ['ENTORN']+' - DAG Kantar Success ',
