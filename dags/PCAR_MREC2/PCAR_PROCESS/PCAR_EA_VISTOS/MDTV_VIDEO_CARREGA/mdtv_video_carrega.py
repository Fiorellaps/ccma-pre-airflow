...
def mdtv_video_carrega(dag: DAG) -> TaskGroup:
    ...
    with TaskGroup(
        ...
        hive_config_consolidacio_B_01_create_video_log_aux["query_name"] = hive_config_consolidacio_B_01_create_video_log_aux['query_file_path'].split('/')[-1].split('.hql')[0].lower()
        ...
        hive_config_consolidacio_B_03_video_log["query_name"] = hive_config_consolidacio_B_03_video_log['query_file_path'].split('/')[-1].split('.hql')[0].lower()
